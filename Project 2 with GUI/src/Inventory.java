...
public class Inventory {
	...
	public void printByName() {
		...
		System.out.format("%20s%15s%15s%10s%20s",  "Product Name", //prints formatted title string
				  							   	    "UPC", 
				  							   	    "Quantity",
				  							   	    "Cost",
				  							   		"Expiration Date");
		...
		for(int index = 0; index < inventoryList.size(); index++) {
			...
			System.out.format("%20s%15s%15s%10s%20s", inventoryList.get(index).getName(), //prints information for each product, formatted to match the title string
	...
	public void printByExpiration() {
		...
		System.out.format("%15s%20s%15s%10s%10s", "Expiration Date", //prints formatted title string
											  	  "Product Name",
											  	  "UPC",
											  	  "Quantity",
											  	  "Cost");
		...
		for (int index = 0; index < inventoryList.size(); index++) {
			...
			System.out.format("%15s%20s%15s%10s%10s", inventoryList.get(index).getExpiration(), //prints information for each product, formatted to match the title string
